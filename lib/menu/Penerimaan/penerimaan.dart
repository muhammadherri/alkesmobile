...
import 'detailPenerimaan.dart';

class Penerimaan extends StatefulWidget {
  final String base;
  Penerimaan({this.base});
  @override
...
class _PenerimaanState extends State<Penerimaan> {
  Future<List> getData() async {
    final response = await http
        .get("$base/index.php?r=api/list&model=request&mode=5&userid=$userid");
                        ...
                        ButtonTheme(
                          ...
                          child: TextButton(
                            style: ElevatedButton.styleFrom(
                              primary: list[i]['status_name'] == 'Dikirim'
                                  ? Colors.green
                                  : Colors.blue,
                            ...
                            TextButton(
                              ...
                              onPressed: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => DetailPenerimaan(
                                            list: list,
                                            index: i,
                                          )),
                                );
