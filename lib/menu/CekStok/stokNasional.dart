...
class StokNasional extends StatefulWidget {
  final String base;
  StokNasional({this.base});
  @override
  _StokNasionalState createState() => _StokNasionalState(
      );
}

class _StokNasionalState extends State<StokNasional> {
  ...
  Future<List> getData() async {
    final response = await http.get(
        "$base/index.php?r=api/stock&item_number=$item_number&item_name=$item_name&cabangid=$selectedNamePaket");
    print(
        '$base/index.php?r=api/stock&item_number=$item_number&item_name=$item_name&cabangid=$selectedNamePaket');
        ...
        appBar: AppBar(
          leading: IconButton(
            ...
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => SearchStokNasional()),
              );
            },
          ),
                              ...
                              child: new Column(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Center(
                                      ...
                                      hint: Text('Tujuan Permintaan'),
                                      items: dataPaket.map(
                                        (list) {
                                          return DropdownMenuItem(
                                              child: Text(list['cabang_name']),
                                              value:
                                                  list['cabang_id'].toString());
                                        },
                                      ).toList(),
                                      onChanged: (value) {
                                        setState(() {
