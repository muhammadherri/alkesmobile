...
import 'package:alkes/menu/Request/additemReqbaru.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import 'package:flutter_offline/flutter_offline.dart';
import 'package:http/http.dart' as http;
import 'package:shared_preferences/shared_preferences.dart';
class additemReq extends StatefulWidget {
  final String base;
  additemReq({this.base});
  @override
  _additemReq2State createState() => _additemReq2State(

      );
}

class _additemReq2State extends State<additemReq> {
