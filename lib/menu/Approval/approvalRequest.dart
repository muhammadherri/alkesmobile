...
import 'package:alkes/menu/Approval/approveDetail.dart';
...
class _ApprovalRequestState extends State<ApprovalRequest> {
  Future<List> getData() async {
    final response = await http
        .get("$base/index.php?r=api/list&model=request&mode=2&userid=$userid");
                        ...
                        ButtonTheme(
                          ...
                          child: TextButton(
                            style: ElevatedButton.styleFrom(
                              primary: list[i]['request_status'] == 0
                                  ? Colors.yellow
                                  : list[i]['request_status'] == 1
                                      ? Colors.lightBlue
                                      : list[i]['request_status'] == 3?Colors.red:Colors.green,
                            ...
                            child: Text(
                              list[i]['status_name'] == ""
                                  ...
                                  : list[i]['status_name'],
                              style: TextStyle(
                                  color: list[i]['status_name'] == "Draft"
                                      ? Colors.black
                                      : Colors.white,
                                  fontSize: 12),
                            ),
                            ...
                            TextButton(
                              ...
                              onPressed: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => DetailApproval(
                                            list: list,
                                            index: i,
                                          )),
                                );
